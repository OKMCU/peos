...
void hal_i2cs_init( st_uint8_t task_id );
void hal_i2cs_task( st_int8_t event_id );

void hal_i2cs_config( st_uint8_t port, const hal_i2cs_config_t *cfg, st_uint8_t num_of_cfg );
...
st_uint8_t hal_i2cs_tx_buf_free( st_uint8_t port );
st_uint8_t hal_i2cs_rx_buf_used( st_uint8_t port );
